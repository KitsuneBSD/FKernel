...
uint64_t sys_clock_gettime([[maybe_unused]] uint64_t clk_id, uint64_t tp_ptr, uint64_t, uint64_t,
  ...
  tp->tv_nsec = (freq > 0) ? (int64_t)((ticks % freq) * 1000000000ULL / freq)
                            : (int64_t)((ticks % 100) * 10000000);
