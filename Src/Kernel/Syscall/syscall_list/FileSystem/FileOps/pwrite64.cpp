...
// sys_pwrite64(...) → 0 or -errno
extern "C" uint64_t sys_pwrite64(uint64_t fd, uint64_t buf_ptr, uint64_t count,
    ...
    auto res = node->write(offset, (size_t)count, reinterpret_cast<const uint8_t*>(buf_ptr));
