 ...
 *
 * @param str     String to tokenize (pass NULL to continue tokenizing previous
 * string).
 ...
 *
 * Compares at most @p n characters of the null-terminated strings @p s1 and @p
