 ...
 * handling of different storage types (e.g., ATA drives, partitions, RAM
 * disks).
 */
class BlockDevice {
private:
...
public:
   ...
   */
  virtual int write(VNode *vnode, FileDescriptor *fd, const void *buffer,
...
// Global VNodeOps for block devices, which will dispatch to the BlockDevice
// interface
