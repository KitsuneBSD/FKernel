...
public:
    ...
    static int ramfs_read(VNode *vnode, FileDescriptor *fd, void *buffer, size_t size, size_t offset);
    static int ramfs_write(VNode *vnode, FileDescriptor *fd, const void *buffer, size_t size, size_t offset);
    static int ramfs_open(VNode *vnode, FileDescriptor *fd, int flags);
    static int ramfs_close(VNode *vnode, FileDescriptor *fd);
    static int ramfs_lookup(VNode *vnode, FileDescriptor *fd, const char *name, RetainPtr<VNode> &out);
    static int ramfs_create(VNode *vnode, FileDescriptor *fd, const char *name, VNodeType type, RetainPtr<VNode> &out);
    static int ramfs_readdir(VNode *vnode, FileDescriptor *fd, void *buffer, size_t max_entries);
