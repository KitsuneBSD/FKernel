...
if not os.execute(nasm_cmd .. src_dir .. "/syscalls.asm -o " .. BUILD_DIR .. "/syscalls.o") then
...
if not os.execute(AR .. " rcs " .. SYSROOT .. "/lib/libfk_user.a " .. BUILD_DIR .. "/syscalls.o") then
    PrintMessage(true, "Failed to create libfk_user.a")
    os.exit(1)
end

print("Installing libfk_user.a...")
os.execute("mkdir -p " .. SYSROOT .. "/lib")
